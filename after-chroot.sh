...
pacman -S --noconfirm networkmanager neovim man-db man-pages texinfo sudo python-pip base-devel dbus-glib xclip wl-clipboard xorg sddm grub vlc htop git npm wget keepassxc obsidian discord sagemath ttc-iosevka

...
pacman -S --noconfirm neovim man-db man-pages texinfo sudo base-devel xorg sddm grub vlc htop git npm wget keepassxc obsidian discord sagemath ttc-iosevka
